...
public class PoolController  {
    ...
    public Pool_address_Domain ReadPool(@PathVariable("id_pool_address") Pool_address_Domain pool) {
    ...
    public boolean deleteUsers(@PathVariable("id_pool_address") Pool_address_Domain pool) {
    ...
    public List<Pool_address_DTO> UpdatePool(@PathVariable("id_pool_address") Pool_address_Domain pool, @RequestBody Pool_address_Domain new_pool) {
    ...
    public List<Pool_address_DTO> CreatePool (@RequestBody Pool_address_Domain pool){
